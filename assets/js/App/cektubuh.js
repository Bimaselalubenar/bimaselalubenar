function cekBeratBadan(event) {
            ...
            if (bmi < 18.5) {
                rekomendasiMakanan = 'Konsumsi makanan tinggi kalori sehat seperti kacang-kacangan, biji-bijian, susu, dan alpukat.';
                makananHindari = 'Hindari makanan rendah kalori dan makanan yang membuat cepat kenyang seperti sayuran tinggi serat.';
                buahCocok = 'Pisang, mangga, alpukat.';
            } else if (bmi >= 18.5 && bmi < 24.9) {
